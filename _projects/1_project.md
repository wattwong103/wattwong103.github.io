...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/portal_mockup.png" title="Portal Application Design Mockup" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Portal Application Design Mockup
</div>
