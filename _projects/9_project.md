...
1. **Chao Phraya Riverfront Revitalization** - Transforming former industrial spaces into vibrant public realms
2. **Transit-Oriented Community Hubs** - Creating gathering spaces around BTS and MRT stations
3. **Pocket Park Networks** - Developing interconnected small green spaces in dense urban areas
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/future-vision.jpg" title="Future vision for Bangkok" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    A vision for Bangkok's connected urban green network, integrating transit, waterways, and public spaces.
</div>
